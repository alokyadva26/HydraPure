...
const alertsData = {
  1: {
    ...
    level: 'Critical',
    desc: 'TDS level is 1500 ppm, which is above the acceptable limit (< 500 ppm). Water supply has been automatically blocked to prevent distribution of unsafe water.',
    parameter: 'TDS',
    value: '1500 ppm',
    range: '< 500 ppm',
